      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center space-y-6 sm:space-y-8 mb-12 sm:mb-16 lg:mb-20">
              ...
              <div className="flex flex-col items-center space-y-4 sm:space-y-6">
                <div className="relative group">
                  <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full blur opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
                  <div className="relative bg-white p-4 sm:p-6 rounded-full shadow-xl border-2 sm:border-4 border-blue-100 group-hover:border-blue-200 transition-all duration-300">
                    <Image 
                      src="/logo.svg" 
                      alt="AI Risk Assessment Tool" 
                      width={80} 
                      height={80}
                      className="h-16 w-16 sm:h-20 sm:w-20 group-hover:scale-110 transition-transform duration-500"
                    />
                  </div>
                </div>
              ...
              <div className="flex justify-center items-center pt-4 sm:pt-6 px-4 sm:px-0">
                <Link href="/questionnaire" prefetch={true} className="w-full sm:w-auto">
                  <Button 
                    size="lg" 
                    className="w-full sm:w-auto text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group"
                  >
                    Start Assessment
            ...
            <Card className="text-center group hover:shadow-xl hover:shadow-blue-100 transition-all duration-300 hover:-translate-y-2 cursor-pointer border-2 hover:border-blue-200 sm:col-span-2 lg:col-span-1">
              <CardContent className="pt-4 sm:pt-6 p-4 sm:p-6">
                <div className="flex justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="mt-12 sm:mt-16 p-4 sm:p-6 bg-blue-50 rounded-lg border border-blue-200 hover:bg-blue-100 hover:shadow-lg transition-all duration-300 group">
            ...
            <ul className="space-y-3 sm:space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start hover:translate-x-2 transition-transform duration-200 cursor-pointer">
                <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 mr-2 mt-0.5 flex-shrink-0 hover:scale-110 transition-transform duration-200" />
